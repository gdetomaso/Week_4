...
class TestStudentLists(TestCase):
    ...
    def test_add_remove_student_ensure_removed(self):
        test_class = ClassList(2)
        test_class.add_student('Mittens')
        test_class.remove_student('Mittens')
        self.assertNotIn('Mittens', test_class.class_list)
    ...
    def test_index_of_student_empty_class(self):
        test_class = ClassList(3)
        index = test_class.index_of_student('Mittens ')
